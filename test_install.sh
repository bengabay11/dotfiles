...
export PATH="$HOME/.cargo/bin:$HOME/.pyenv/bin:$PATH:/usr/local/bin:/usr/bin:$HOME/.local/bin"
...
main() {
    ...
    run_test "pyenv can list available versions" "test_command_exists pyenv install --list"
    run_test "pyenv global Python is usable" "test_command_exists pyenv exec python3 --version"
